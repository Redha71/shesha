                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="name" class="form-control" required=""
                                                            data-validation-required-message="The User Name is required" value="{{$adminData->name}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="email" name="email" class="form-control" required=""
                                                            data-validation-required-message="Emial is required" value="{{$adminData->email}}">
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>
